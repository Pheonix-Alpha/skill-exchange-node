...
const testimonials = [
  {
    ...
    initials: "AS",
    color: "bg-blue-500",
    quote: "I taught React and learned UI design in return. Best trade I ever made — saved me thousands in courses.",
    rating: 5,
    tag: "React ↔ Figma",
  },
  {
    ...
    initials: "RM",
    color: "bg-purple-500",
    quote: "Found a Python developer who needed logo work done. We both got exactly what we needed in a week.",
    rating: 5,
    tag: "Logo ↔ Python",
  },
  {
    ...
    quote: "Exchanged copywriting for SEO training. The community here is genuinely skilled and trustworthy.",
    rating: 5,
    tag: "Copy ↔ SEO",
  },
];
    ...
    <section className="bg-[#0A0A0F] py-24 px-6 border-t border-white/5">
      <div className="max-w-[1200px] mx-auto">
        <div className="text-center mb-14">
          <p className="text-[#4F8EF7] text-xs font-bold uppercase tracking-[0.2em] mb-3">Community love</p>
          ...
          {testimonials.map((t, i) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 pt-1 border-t border-white/5">
                <div className={`w-9 h-9 rounded-xl ${t.color} flex items-center justify-center text-white text-xs font-black shrink-0`}>
                  {t.initials}
                </div>
                <div>
